...
public class DetailActivity extends AppCompatActivity {
    ...
    private TextView tvSandwichName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //tvSandwichName=findViewById(R.id.tv_sandwichName);
